      ...
      - name: Install Gambit
        ...
        run: |
          curl --proto '=https' --tlsv1.2 -LsSf \
            https://github.com/diegoglozano/gambit/releases/download/v0.15.0/gambit-installer.sh | sh
...
The workflow pins Gambit v0.15.0 so its behavior cannot change unexpectedly.
